...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update query
    $updateQuery = $conn->prepare("UPDATE suppliers SET firstname=?, shop=?, email=?, mobile=?, address=?, image=? WHERE id=?");
    $updateQuery->bind_param("ssssssi", $first_name, $shop, $email, $mobile, $address, $image_path, $supplier_id);
    ...
    <div class="profile-container">
        <div class="profile-sidebar">
            <div class="profile-header">
                ...
                <p><strong>Shop Name:</strong> <?php echo $user['shop']; ?></p>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="profile-info">
                    ...
                    <div>
                        ...
                        <input type="text" name="shop" value="<?php echo $user['shop']; ?>" required readonly>
                    </div>
                    <div>
                        <label>Email</label>
                    ...
                    <div>
                        <label>Mobile</label>
                        <input type="tel" name="mobile" value="<?php echo $user['mobile']; ?>" required readonly>
                    </div>
                    <div>
                        <label>Address</label>
